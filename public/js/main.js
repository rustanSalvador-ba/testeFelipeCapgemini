...
exports.default = {
  ...
  methods: {
    creditar: function creditar(ev, item) {
      var _this = this;

      ev.preventDefault();
      this.valor = this.$refs.valor.value;
      this.$http.get('/creditar/' + item.id + '/' + this.valor).then(function (req) {
        return _this.$set(item, 'saldo', req.data.valor);
      });
    },
    debitar: function debitar(ev, item) {
      var _this2 = this;

      ev.preventDefault();
      this.valor = this.$refs.valor.value;
      this.$http.get('/debitar/' + item.id + '/' + this.valor).then(function (req) {
        return _this2.$set(item, 'saldo', req.data.valor);
      });
    }
  },
...
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<div _v-714580a0=\"\">\n\n<div class=\"container\" _v-714580a0=\"\">\n\n<h1 _v-714580a0=\"\"> Contas </h1>\n    <div class=\"form-group\" _v-714580a0=\"\">\n    <label for=\"filtro\" _v-714580a0=\"\">Nome do Titular </label>\n     <input class=\"form-control col-md-6\" id=\"filtro\" type=\"text\" placeholder=\"Pesquise o nome aqui..\" _v-714580a0=\"\">\n         <label for=\"valor\" _v-714580a0=\"\">Valor da Operação </label>\n     <input type=\"text\" id=\"valor\" class=\"form-control col-md-2\" placeholder=\"Digite o valor\" ref=\"valor\" _v-714580a0=\"\">\n    </div>  \n   \n                                                                                    \n  <div class=\"table-responsive\" _v-714580a0=\"\">          \n  <table class=\"table table-bordered table-striped\" _v-714580a0=\"\">\n    <thead _v-714580a0=\"\">\n      <tr _v-714580a0=\"\">\n        <th _v-714580a0=\"\">Conta</th>\n        <th _v-714580a0=\"\">Nome</th>\n        <th _v-714580a0=\"\">Saldo</th>\n        <th _v-714580a0=\"\">Crédito</th>\n        <th _v-714580a0=\"\">Débito</th>\n      </tr>\n    </thead>\n    <tbody id=\"tabela\" _v-714580a0=\"\">\n    \n      <tr v-for=\"c in list\" _v-714580a0=\"\">\n        <td _v-714580a0=\"\">{{c.id}}</td>\n        <td _v-714580a0=\"\">{{c.nome}}</td>\n        <td _v-714580a0=\"\">R${{c.saldo}}</td>\n        <td _v-714580a0=\"\"> <a href=\"#\" @click=\"creditar($event, c)\" _v-714580a0=\"\">Creditar</a></td>\n        <td _v-714580a0=\"\"> <a href=\"#\" @click=\"debitar($event, c)\" _v-714580a0=\"\">Debitar</a></td>\n      </tr>\n    </tbody>\n  </table>\n  </div>\n</div>\n</div>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-714580a0", module.exports)
  } else {
    hotAPI.update("_v-714580a0", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
var _contas = require('./components/contas.vue');

var _contas2 = _interopRequireDefault(_contas);
...
},{"./components/contas.vue":9,"vue-resource":4,"vue/dist/vue.js":5}]},{},[10]);
